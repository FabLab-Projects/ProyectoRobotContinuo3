...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        # Establecer los límites del eje Y entre 0 y 1023
        self.graphWidget1.setYRange(100, 600)
        self.graphWidget2.setYRange(100, 600)
        self.graphWidget3.setYRange(100, 600)
        self.graphWidget4.setYRange(100, 600)
        ...
        self.timer = QTimer()
        self.timer.setInterval(1)  # Intervalo en milisegundos
        self.timer.timeout.connect(self.update_plot_data)
        self.timer.start()

        # Configurar la comunicación serial
        try:
            self.ser = serial.Serial('COM5', 115200)  # Reemplaza 'COM3' por el puerto correcto
